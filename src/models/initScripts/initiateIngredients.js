...
function gatherNonVeganIngredients(done) {
    var lines = rawNotVegan.split('\n');
    ...
    series(gatherFunctionArray, done, done);
}

function gatherPossiblyNonVeganIngredients(done) {
    var lines = rawPossiblyNotVegan.split('\n');
    var gatherFunctionArray = [];
    lines.forEach((line)=> {
        gatherFunctionArray.push((insideDone)=> {
            line = line.slice(2);
...
function gatherVeganIngredients(done) {
    var codes = rawPossiblyNotVegan.split(',');
    var gatherFunctionArray = [];
    codes.forEach((code)=> {
        gatherFunctionArray.push((insideDone)=> {
...
function main(done) {
    console.log("starting ingredients Intiation.");
